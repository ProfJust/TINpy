...
class Snowflake:
    ...
    def update(self):
        ...
        # Wenn unten raus -> wieder oben erscheinen
        if self.y > HEIGHT:
            self.reset()
...
class Sleigh:
    def __init__(self):
        ...
        self.height = 80
        self.y = HEIGHT * 0.35
        self.x = -self.width - 100  # Start links außerhalb
        self.speed = 3.0

    def update(self):
        # Leichte Wellenflug-Bewegung
...
def main():
    ...
    pygame.display.set_caption("Rentierschlitten im Schnee (Fullscreen)")
    ...
    running = True
    while running:
        # ESC oder Fenster-Schließen beendet das Programm
